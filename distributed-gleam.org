...
The send_exit function can send an 'out of band' exit message to terminate the process.
...
The "send_exit" message type doesn't end up in the 'actor' loop function.
